...
class MasterUserPassword extends StatefulWidget {
  final int id;
  ...
  @override
  _MasterUserPasswordState createState() => _MasterUserPasswordState();
}

class _MasterUserPasswordState extends State<MasterUserPassword> {
  ...
  ubahPassword() async {
    ...
    final response = await http.post(
      Uri.parse("$kIpAddress/api/admin/users/$iduser/password/put"),
      body: body,
    );
