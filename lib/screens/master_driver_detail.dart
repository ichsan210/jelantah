...
class MasterDriverDetail extends StatefulWidget {
  final int id;
  ...
  @override
  _MasterDriverDetailState createState() => _MasterDriverDetailState();
}

class _MasterDriverDetailState extends State<MasterDriverDetail> {
                          ...
                          child: TextButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => MasterDriverPassword(id: widget.id)));
  ...
  void showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Simpan data driver ini?"),
      actions: [
        cancelButton,
        continueButton,
      ],
